class User < ApplicationRecord
  ...
  has_many :current_followers, through: :followers, source: 'followed', dependent: :destroy

  has_many :followeds, class_name: 'Following', foreign_key: 'followed_id', dependent: :destroy
  has_many :current_followeds, through: :followeds, source: 'follower', dependent: :destroy
